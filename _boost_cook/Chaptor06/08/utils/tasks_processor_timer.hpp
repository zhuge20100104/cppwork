#ifndef _CHAPTOR06_08_TASKS_PROCESSOR_TIMER_HPP_
#define _CHAPTOR06_08_TASKS_PROCESSOR_TIMER_HPP_
    ...
    struct timer_task: public task_wrapped<Functor> {
        ...
        public:
            ...
            explicit timer_task(
                ...
                timer_(boost::make_shared<boost::asio::deadline_timer>(ios, duration_or_time)) {
            }
