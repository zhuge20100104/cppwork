...
std::vector<std::string> types {"T-shirt/top", "Trouser", "Pullover", "Dress", "Coat", "Sandal", "Shirt", "Sneaker", "Bag", "Ankle boot"};
...
TEST(TfFashionModelTest, LoadAndPredictPic) {
    ...
    for(int i=0; i<pre_num; ++i) {
        ...
        std::cout << "Predict result: " << types[predict_res[0]] << "\n";
    }
}
