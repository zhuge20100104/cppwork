...
MODEL                   = first_1
MODULES                 = first_1_msf.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/first_1_msf.mexa64
MAKEFILE                = first_1.mk
...
MODELLIB                  = first_1_msf.mexa64
MODELREF_LINK_LIBS        = ../../../../slprj/sim/first_1/first_1lib.a
...
MODELREF_LINK_LIBS_GROUP = ../../../../slprj/sim/first_1/first_1lib.a
ifeq ($(COMPUTER),GLNXA64)
  MODELREF_LINK_LIBS_GROUP = -Wl,--start-group ../../../../slprj/sim/first_1/first_1lib.a -Wl,--end-group
endif
...
first_1_msf.o : $(START_DIR)/slprj/sim/first_1/first_1_msf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/sim/first_1/first_1_msf.c
