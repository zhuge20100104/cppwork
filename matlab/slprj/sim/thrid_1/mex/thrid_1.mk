...
MAKECMD         = /home/fredric/software/matlab/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = thrid_1
MODULES                 = thrid_1_msf.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/thrid_1_msf.mexa64
MAKEFILE                = thrid_1.mk
MATLAB_ROOT             = /home/fredric/software/matlab
ALT_MATLAB_ROOT         = /home/fredric/software/matlab
START_DIR               = /home/fredric/code/cppwork/matlab
...
SYSTEM_LIBS             = -L"/home/fredric/software/matlab/bin/glnxa64" -lfixedpoint -lmwmathutil -lmwipp -lmwsl_AsyncioQueue -lmwsf_runtime -lmwslexec_simlog -lmwcoder_ToAsyncQueueTgtAppSvc -lmwsl_simtarget_instrumentation -lmwsl_simtarget_core -lmwstringutil -lmx -lmex
...
MODELLIB                  = thrid_1_msf.mexa64
MODELREF_LINK_LIBS        = ../../../../slprj/sim/thrid_1/thrid_1lib.a ../../../../slprj/sim/first_1/first_1lib.a
...
MODELREF_LINK_LIBS_GROUP = ../../../../slprj/sim/thrid_1/thrid_1lib.a ../../../../slprj/sim/first_1/first_1lib.a
ifeq ($(COMPUTER),GLNXA64)
  MODELREF_LINK_LIBS_GROUP = -Wl,--start-group ../../../../slprj/sim/thrid_1/thrid_1lib.a ../../../../slprj/sim/first_1/first_1lib.a -Wl,--end-group
endif
...
# Additional includes 
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/sim/first_1 \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/thrid_1 \
...
thrid_1_msf.o : $(START_DIR)/slprj/sim/thrid_1/thrid_1_msf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/sim/thrid_1/thrid_1_msf.c
